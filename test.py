...
parser.add_argument('--model_path', default='/data/hyperparameter/Cross_Modal_video_1/save_model/', type=str,
...
def test1():
    ...
    # np.savetxt("g_pids_noise.txt", g_pids, fmt='%d', delimiter=',')
    ...
    # np.savetxt("q_pids_noise.txt", q_pids, fmt='%d', delimiter=',')
